...
static const keyword_class_cfg_t KEYWORD_CLASSES_CFG[] = {    
    [KEYWORD_LIGHTS_OFF]  = { .name = "LIGHTS_OFF", .count_needed = 2, .threshold_percent = 0 },
    [KEYWORD_LIGHTS_ON]   = { .name = "LIGHTS_ON",  .count_needed = 2, .threshold_percent = 60 },
...
static bool is_keyword_phrase_first_word(uint16_t predicted_class)
{
return (predicted_class == KEYWORD_LIGHTS_OFF) || (predicted_class == KEYWORD_LIGHTS_ON);
}
