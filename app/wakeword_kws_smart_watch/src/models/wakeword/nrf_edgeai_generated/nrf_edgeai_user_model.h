...
#ifndef _NRF_EDGEAI_USER_MODEL_92556_H_
#define _NRF_EDGEAI_USER_MODEL_92556_H_
 ...
 */
nrf_edgeai_t* nrf_edgeai_user_model_92556(void);
/** 
 ...
 */ 
uint32_t nrf_edgeai_user_model_neuton_size_92556(void);

/** 
 * @brief Alias for the Nordic Edge AI Lab user model API name.
 */
#ifndef nrf_edgeai_user_model
#define nrf_edgeai_user_model nrf_edgeai_user_model_92556
#endif
...
#define nrf_edgeai_user_model_neuton_size nrf_edgeai_user_model_neuton_size_92556
#endif
...
#endif /* _NRF_EDGEAI_USER_MODEL_92556_H_ */
