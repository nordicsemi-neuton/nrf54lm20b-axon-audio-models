...
static const keyword_class_cfg_t KEYWORD_CLASSES_CFG[] = {    
    [KEYWORD_ANSWER]   = { .name = "ANSWER",   .count_needed = 2, .threshold_percent = 0 },
    [KEYWORD_CALL]     = { .name = "CALL",     .count_needed = 2, .threshold_percent = 70 },
    [KEYWORD_CONTINUE] = { .name = "CONTINUE", .count_needed = 2, .threshold_percent = 0 },
    [KEYWORD_END]      = { .name = "END",      .count_needed = 2, .threshold_percent = 60 },
    [KEYWORD_HELP]     = { .name = "HELP",     .count_needed = 2, .threshold_percent = 70 },
    ...
    [KEYWORD_SUPPORT]  = { .name = "SUPPORT",  .count_needed = 2, .threshold_percent = 0 },
    [KEYWORD_TIME]     = { .name = "TIME",     .count_needed = 2, .threshold_percent = 70 },
    [KEYWORD_WAIT]     = { .name = "WAIT",     .count_needed = 2, .threshold_percent = 60 },
    [KEYWORD_WEATHER]  = { .name = "WEATHER",  .count_needed = 2, .threshold_percent = 0 },
};
...
static bool is_keyword_phrase_first_word(uint16_t predicted_class)
{
return (predicted_class == KEYWORD_ANSWER) || (predicted_class == KEYWORD_CALL) ||
       (predicted_class == KEYWORD_CONTINUE) || (predicted_class == KEYWORD_END) ||
       (predicted_class == KEYWORD_HELP) || (predicted_class == KEYWORD_WAIT) ||
       (predicted_class == KEYWORD_STOP) || (predicted_class == KEYWORD_SUPPORT) ||
       (predicted_class == KEYWORD_TIME) || (predicted_class == KEYWORD_WEATHER);
}
