...
#define AXON_MFCC_FRAME_LEN 480       // Number of audio samples per frame, maximum value is 512 (limited by longest FFT supported)
#define AXON_MFCC_FRAME_SHIFT 320     // number of samples to shift between frames.
#define AXON_MFCC_SAMPLE_RATE 16000
#define AXON_MFCC_FILTERBANK_COUNT 40
 ...
 */
#define AXON_MFCC_SLICE_CNT 49  

/*
 * MFCC parameters
 */
#define AXON_MFCC_MFCC_ENERGY_APPEND 0  // set to 1 if MFCC should be replaced with the log of the FFT energy
#define AXON_MFCC_MFCC_FFT_MAGNITUDE 1  // set to 1 if square-root should be taken of FFT power prior to filter banks.
