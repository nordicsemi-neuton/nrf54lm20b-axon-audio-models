...
These tests demonstrate a variety of ways axon acceleration can be used. This includes neural network inference, dsp-like algorithms (used for feature extraction), and combining the two into a use-case.
...
*********************
All applications under `axon/tests` can target zephyr or the simulator. 
...
Sample compiled model header files are placed here. This is added to the include paths of inference so any model placed in this folder will be available to that application.
