...
#. Select one of the sample models in `<../compiled_models>`_ or copy your own model header files to that folder. (See `tools/axon/compiler/scripts <../../../tools/axon/compiler/scripts>`_ for details on compiling a model.)
